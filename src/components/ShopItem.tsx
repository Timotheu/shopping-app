...
const ShopItem: React.FC<ProductDetails> = ({id, title, image, price}) => {
  ...
  const quantityButton: ReactNode = (quantity === 0 ? 
    ...
    (
    <div className="flex align-items-center flex-col mb-5">
      ...
      <button onClick={() => removeFromCart(id)} className="bg-red-300 hover:bg-blue-300 text-white font-bold rounded mt-2 remove-button"> Remove </button>
    </div>
  )
  )
